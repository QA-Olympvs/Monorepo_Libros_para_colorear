...
class dragado_tipo5LBS extends componentBase {
	...
	async getData() {
        ...
        xmlhttp.open("GET","componentsAndroid/dragado_tipo5LBS/dragado_tipo5LBS.html",true);
        xmlhttp.send();
    }
	...
	updateStyle() {
		...
		linkCompontCss.setAttribute("href", "componentsAndroid/dragado_tipo5LBS/dragado_tipo5LBS.css");
