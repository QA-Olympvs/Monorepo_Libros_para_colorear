...
class dragado_tipo1LBS extends componentBase {
    botonAnterior;
    botoSeleccionado;
    colorSeleccionado;
    ...
    async getData() {
        ...
        xmlhttp.open("GET","componentsAndroid/dragado_tipo1LBS/dragado_tipo1LBS.html",true);
        xmlhttp.send();
...
customElements.define('lbs-dragado-tipo1',dragado_tipo1LBS);