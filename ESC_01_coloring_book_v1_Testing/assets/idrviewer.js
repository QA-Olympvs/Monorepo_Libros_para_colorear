/*! IDRViewer - v1.8.0 | Copyright 2018 IDRsolutions */ ! function() {
    ...
    m.setup = function(n) {
        ...
        compConfig.open("GET", "componentsAndroid/config.json?t=" + DateTime, !0), compConfig.onload = function() {                                             
                if ((compConfig.status >= 200 || compConfig.status == 0 ) && compConfig.status < 400) {
                        ...
                        var i = function() {
                                ...
                                c.setAttribute("class", "page-inner"), c.setAttribute("src", y + b + ".html"),c.setAttribute("id", "iframe" + y + b), c.setAttribute("style", "width: " + g[b - 1][0] + "px; height: " + g[b - 1][1] + "px; position: relative; border: 0;"), c.onload = function() {
                                    ...
                                    var metaViewPort = document.createElement("meta");
                                            ...
                                            metaViewPort.content="width=device-width, viewport-fit=cover";
                                            document.getElementById("iframe"+y +b).contentWindow.document.head.appendChild(metaViewPort);
                                    ...
                                    var jsScriptBase = document.createElement("script") 
                                            jsScriptBase.src="componentsAndroid/componentBase.js?t="+DateTime;
                                    ...
                                    jsScriptBase.onload = function(){
                                        for (var i = 0; i < components.length; i++) {
                                            var jsScript = document.createElement("script") 
                                                jsScript.src="componentsAndroid/"+components[i]+"/"+components[i]+".js?t="+DateTime;
