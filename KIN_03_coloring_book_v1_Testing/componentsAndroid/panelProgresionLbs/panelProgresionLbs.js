class panelProgresionLbs extends componentBase {
    ...
    xmlhttp.open("GET","components/panelProgresionLbs/panelProgresionLbs.html", true);
    xmlhttp.send();
  }
	...
	updateStyle(elem) {
   	const shadow = elem.shadowRoot;
		...
		linkCompontCss.setAttribute("href", "components/panelProgresionLbs/panelProgresionLbs.css");
	...
	_showPanel(data, proyectoPag) {
		console.log("PANEL")
		console.log(data)
		console.log(proyectoPag)
		this.style.display = "block";
		const textoTitulo = proyectoPag; 
		const contenidoData = data === undefined ? '<p><b><i>No existe progresión aún.</i><b></p>' : data;
...
customElements.define('panel-progresion-lbs', panelProgresionLbs);