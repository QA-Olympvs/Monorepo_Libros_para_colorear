...
class dragado_tipo3LBS extends componentBase {
	...
	async getData() {
        ...
        xmlhttp.open("GET","components/dragado_tipo3LBS/dragado_tipo3LBS.html",true);
        xmlhttp.send();
    }
	...
	updateStyle() {
		...
		linkCompontCss.setAttribute("href", "components/dragado_tipo3LBS/dragado_tipo3LBS.css");
