    ...
    observers(){
        this._unsubscribe = this.Visor.store.subscribe(()=>{
            ...
            if(search != 0) {
                ...
                if(removedItem[1] === "REMOVE_DATA"){
                    if(removedItem[0] == this._id){
            ...
            if(search2 != 0) {
                if(!! document.getElementById("line_"+search[0]?.data)) {
                    ...
                    if(search2[0].elemento.includes(removedItem[0])){
                        // console.log("Encuentra la línea en otra página");
                        line = search2[0].elemento

                    }
                }
                else{
                    if(removedItem[0] == search2[0].elemento){
                    }
                    else{
                        // console.log(search2[0].elemento);
                        line = search2[0].elemento
                    }
                    var h = document.getElementById("p"+this._pagina);
                    h.insertAdjacentHTML("beforeend", search2[0].data);
                ...
                if(removedItem[1] === "REMOVE_DATA"){
                    if(removedItem[0] == line){
                        // console.log("removed y id son iguales linea");
                        line = null;
                        removedItem[1] = null;
                        const linea = document.getElementById(removedItem[0]);
                        linea.remove();
                        // console.log(line);
                    }
                }
