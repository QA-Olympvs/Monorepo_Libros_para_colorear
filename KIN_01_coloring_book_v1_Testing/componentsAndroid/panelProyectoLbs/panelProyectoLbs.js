class panelProyectoLbs extends componentBase {
    ...
    xmlhttp.open("GET","componentsAndroid/panelProyectoLbs/panelProyectoLbs.html", true);
    xmlhttp.send();
  }
	...
	updateStyle(elem) {
   	const shadow = elem.shadowRoot;
		...
		linkCompontCss.setAttribute("href", "componentsAndroid/panelProyectoLbs/panelProyectoLbs.css");
	...
	_showPanel(data, proyectoPag) {
		...
		const contenidoData = data === undefined ? '<p><b><i>No existe contenido aun. Por favor añadirlo desde PerseusApp.</i><b></p>' : data.data;
