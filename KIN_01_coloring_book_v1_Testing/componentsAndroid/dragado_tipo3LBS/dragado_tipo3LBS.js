...
class dragado_tipo3LBS extends componentBase {
	constructor() {
		super();
		this.endPositions = [];
		this.endElements;
	...
	async getData() {
        ...
        xmlhttp.open("GET","componentsAndroid/dragado_tipo3LBS/dragado_tipo3LBS.html",true);
        xmlhttp.send();
    }
	...
	updateStyle() {
		...
		linkCompontCss.setAttribute("href", "componentsAndroid/dragado_tipo3LBS/dragado_tipo3LBS.css");
...
customElements.define('lbs-dragado-tipo3', dragado_tipo3LBS);